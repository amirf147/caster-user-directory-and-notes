...
| :--- | :--- | :--- |
| **ADCE Plugin Client** | `caster_user_content/plugins/adce/client.py` *(pending publication)* | Background thread listening to ADCE's SSE endpoint (`http://127.0.0.1:8424/sse`), maintaining atomic in-memory state. |
