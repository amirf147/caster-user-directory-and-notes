...
> [!NOTE]
> **Document Status**: *Active Specification (Taskbar HUD Subsystem; Not Superseded)*.  
> Defines the Windhawk XAML injection, named pipe IPC, and single command strip architecture for the Windows 11 Taskbar HUD.
...
The Caster Taskbar HUD is an experimental Windhawk modification (`caster-taskbar-hud.wh.cpp`) designed to inject real-time voice telemetry directly into the Windows 11 taskbar adjacent to the system tray. During live testing, two primary defects occurred:
