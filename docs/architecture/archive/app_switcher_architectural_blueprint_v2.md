...
[ 🏠 Docs Home ](../../README.md) › [ 🏗️ Architecture ](../app_switcher_architectural_blueprint.md) › [ 🗄️ Architecture Archive ](./) › **Architectural Blueprint v2: `util/app_switcher.py` (Archived)**
