...
class CustomMarkdown(MergeRule):
    ...
    extras = [
        ...
        Choice(
            "element", {
                ...
                "small math": "dollar, space:2, dollar, left:2",
                "math": "dollar:2, space:2, dollar:2, left:3",
...
def get_rule():
    return CustomMarkdown, RuleDetails(ccrtype=CCRType.GLOBAL)
