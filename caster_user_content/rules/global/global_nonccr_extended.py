...
copy and paste it: ") + Key("c-v")),
        ...
        "position [window] restore": R(Key("w-r/30") + Text(RUN_COMMANDS["restore window positions"], pause=0.0) + Key("enter")),
        "position [window] save": R(Key("w-r/30") + Text(RUN_COMMANDS["save window positions"], pause=0.0) + Key("enter")),
